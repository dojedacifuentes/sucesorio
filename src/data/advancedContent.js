...
export const advancedDetectiveCases = [
  ...
  caseFile("transmision-apaga-acrecer", "La cuota que no acrecio", "Transmision vs acrecimiento", 5, "derechos-concurrentes", "El testamento deja una misma cuota a Ada y Bruno por iguales partes. Bruno sobrevive al causante, muere tres dias despues sin aceptar ni repudiar, y Ada exige que todo acrezca a su favor. La pantalla del archivo marca una sola palabra: cronologia.", ["Bruno sobrevivio al causante", "No hay aceptacion ni repudiacion", "Ada invoca acrecimiento por falta del coasignatario"], "Aplicar transmision y excluir el acrecimiento cuando el asignatario alcanzo a ser llamado.", [
    choice("Aplicar acrecimiento y entregar toda la cuota a Ada.", false, "1147/1153", "Acrecimiento", "Incorrecto. Bruno no falto antes de la delacion; sobrevivio y transmitio su derecho."),
    choice("Reconocer transmision a los herederos de Bruno; esta excluye el acrecimiento.", true, "957/1153", "Transmision", "Correcto. Si Bruno muere despues de la delacion sin decidir, sus herederos reciben el derecho de aceptar o repudiar."),
    choice("Abrir representacion porque Bruno murio.", false, "984", "Representacion", "Incorrecto. La representacion mira al llamado que no quiso o no pudo suceder antes del llamamiento efectivo; aqui ya hubo delacion a Bruno."),
  ]),
  caseFile("sustituto-contra-acrecedor", "El suplente del testador", "Sustitucion vulgar", 5, "derechos-concurrentes", "La causante instituye a Noelia y Omar en una misma asignacion. Agrega una linea seca: 'si Noelia falta, la reemplaza Pilar'. Noelia muere antes de la apertura. Omar prepara discurso de acrecimiento; Pilar trae el testamento subrayado.", ["Coasignatarios conjuntos", "Sustitucion vulgar expresa", "Noelia falta antes de deferirse la asignacion"], "Preferir la sustitucion vulgar expresamente ordenada por el testador por sobre el acrecimiento.", [
    choice("Dar la porcion de Noelia a Pilar como sustituta vulgar.", true, "1156/1163", "Sustitucion", "Correcto. La sustitucion llamada por el testador entra antes que el acrecimiento."),
    choice("Hacer acrecer la porcion de Noelia a Omar.", false, "1147/1163", "Acrecimiento", "Incorrecto. El acrecimiento queda desplazado por la sustitucion vulgar expresa."),
    choice("Aplicar transmision a los herederos de Noelia.", false, "957", "Transmision", "Incorrecto. Noelia falto antes de la delacion; no alcanzo a transmitir derecho de aceptar o repudiar."),
  ]),
  caseFile("indigno-con-descendencia", "La rama del indigno", "Representacion del indigno", 5, "derechos-concurrentes", "El hijo del causante fue declarado indigno por ocultar dolosamente el testamento. Sus dos hijos piden ocupar su lugar. La familia quiere castigar a toda la rama; el Codigo no compra castigos hereditarios por arrastre.", ["Indignidad declarada judicialmente", "Descendientes del indigno", "Solicitud de heredar por estirpe"], "Permitir la representacion del indigno por sus descendientes cuando concurren los requisitos.", [
    choice("Excluir tambien a los nietos por la indignidad del padre.", false, "987", "Representacion", "Incorrecto. La indignidad es personal; la ley admite representar al indigno."),
    choice("Permitir que los nietos representen al indigno y tomen por estirpe.", true, "984/985/987", "Representacion", "Correcto. Se puede representar al indigno; la porcion se toma por estirpe."),
    choice("Transmitir a los nietos la herencia con el mismo vicio por cinco anos.", false, "977", "Indignidad", "Incorrecto. Esa regla mira la transmision de lo que el indigno alcanzo a adquirir; aqui el caso se resuelve por representacion sucesoria."),
  ]),
  caseFile("desheredamiento-generico", "La clausula de ingratitud", "Desheredamiento defectuoso", 5, "mejoras-pactos", "El testamento dice: 'desheredo a mi hija por ingratitud, malas visitas y silencios ofensivos'. No identifica causal legal ni existe prueba judicial previa. Los demas herederos dicen que la frase suena convincente en neon.", ["Legitimaria privada de legitima", "Causal generica no especificada", "No consta prueba judicial de la causal"], "Detectar que el desheredamiento exige causal legal especifica y prueba en los terminos del Codigo.", [
    choice("Mantener el desheredamiento porque el testador fue claro en su molestia.", false, "1207/1209", "Desheredamiento", "Incorrecto. La molestia no es causal autonoma y el desheredamiento debe ajustarse estrictamente a la ley."),
    choice("Impugnar el desheredamiento y pedir lo que corresponde por legitima.", true, "1207/1209/1217", "Reforma", "Correcto. Sin causal especifica y prueba suficiente, la clausula no vale para privar la legitima."),
    choice("Transformar la clausula en indignidad automatica.", false, "968/974", "Indignidad", "Incorrecto. La indignidad requiere causal y declaracion judicial; no nace por redaccion dramatica."),
  ]),
  caseFile("legitimario-en-silencio", "El heredero borrado en tinta blanca", "Legitimario omitido", 5, "acciones-protectoras", "El causante instituye herederos a dos hijos y guarda silencio absoluto sobre una tercera hija. El archivo no muestra desheredamiento ni renuncia. La hija omitida mira el margen vacio como si fuera una demanda.", ["Legitimaria pasada en silencio", "No hay desheredamiento", "Testamento distribuye como si ella no existiera"], "Aplicar la regla del legitimario pasado en silencio y, si es necesario, accionar de reforma.", [
    choice("Entender a la hija omitida instituida en su legitima y ajustar el testamento.", true, "1218/1216", "Legitimario omitido", "Correcto. El silencio no borra al legitimario; se entiende instituido en su legitima."),
    choice("Declarar nulo todo el testamento por omitir a una hija.", false, "1218", "Reforma", "Incorrecto. La solucion no es quemar todo el instrumento, sino integrar la legitima que corresponde."),
    choice("Excluirla por no haber sido nombrada expresamente.", false, "1182/1218", "Legitimarios", "Incorrecto. Los legitimarios no dependen de una aparicion estetica en el testamento."),
  ]),
  caseFile("mejoras-al-tercero", "La cuarta enviada fuera de la familia", "Cuarta de mejoras", 5, "mejoras-pactos", "Con descendientes vivos, la testadora asigna toda la cuarta de mejoras a su socio de laboratorio juridico. Los hijos no discuten la libre disposicion; discuten esa cuarta con alarma quirurgica.", ["Existen descendientes", "Cuarta de mejoras asignada a un tercero", "Legitimarios piden correccion"], "Reformar la disposicion de mejoras hecha a favor de quien no puede recibirla por esa via.", [
    choice("Mantener la mejora porque el testador puede mejorar a quien quiera.", false, "1195", "Mejoras", "Incorrecto. La cuarta de mejoras solo puede distribuirse entre conyuge, descendientes y ascendientes."),
    choice("Reformar el testamento en esa parte y adjudicar la mejora conforme a derecho.", true, "1195/1220", "Accion de reforma", "Correcto. Si la cuarta de mejoras sale a un tercero, los legitimarios pueden pedir reforma."),
    choice("Atacar con inoficiosa donacion porque es una disposicion testamentaria.", false, "1187", "Inoficiosa", "Incorrecto. La inoficiosa mira donaciones; aqui el remedio central es reforma del testamento."),
  ]),
  caseFile("pacto-no-mejorar", "La promesa sellada", "Pacto de no mejorar", 5, "mejoras-pactos", "Por escritura publica, el causante prometio a su conyuge no disponer de la cuarta de mejoras. Anos despues, su testamento reparte esa cuarta entre dos descendientes. La escritura vieja despierta como archivo ejecutable.", ["Promesa por escritura publica", "Favorecido era legitimario", "Testamento posterior infringe la promesa"], "Aplicar el pacto excepcional de no mejorar y calcular lo que los asignatarios deben enterar al favorecido.", [
    choice("Tener por nula toda la sucesion futura pactada.", false, "1204", "Pacto sucesorio", "Incorrecto. El pacto de no mejorar es una excepcion precisa; no anula todo el testamento."),
    choice("Dar al favorecido lo que le habria valido cumplir la promesa, a prorrata del provecho de los asignatarios.", true, "1204", "Pacto de no mejorar", "Correcto. El art. 1204 permite esta promesa concreta y da accion contra los beneficiados por la infraccion."),
    choice("Ignorar la escritura porque todos los pactos sucesorios son validos solo si hay testamento.", false, "1204/1463", "Pactos", "Incorrecto. La regla es restrictiva: esta promesa especifica vale; las otras estipulaciones sobre sucesion futura no."),
  ]),
  caseFile("alimentos-en-la-masa", "La pension que sobrevivio", "Alimentos forzosos", 5, "acciones-protectoras", "El causante debia alimentos judicialmente fijados a su ascendiente. Al morir, los herederos anotan la deuda como 'asunto personal extinto'. El expediente conserva el comprobante como si tuviera pulso.", ["Alimentos debidos por ley", "Muerte del alimentante", "Herederos intentan borrar la carga"], "Reconocer que los alimentos legales debidos por el difunto gravan la masa hereditaria, con reglas de proporcionalidad para lo futuro.", [
    choice("Extinguir automaticamente toda obligacion alimenticia por la muerte.", false, "1168/1170", "Alimentos", "Incorrecto. Los alimentos que el difunto debia por ley gravan la masa hereditaria."),
    choice("Cargar los alimentos legales a la masa, sin perjuicio de rebajar futuros desproporcionados.", true, "1168/1170", "Asignacion forzosa", "Correcto. No todo muere con el causante; ciertas cargas entran al calculo sucesorio."),
    choice("Imputar los alimentos a la cuarta de libre disposicion siempre.", false, "1171", "Alimentos voluntarios", "Incorrecto. Esa ruta sirve para alimentos voluntarios o excesos; aqui se trata de alimentos debidos por ley."),
  ]),
  caseFile("legado-cosa-ajena", "El inmueble que no era suyo", "Legado de cosa ajena", 5, "herederos-legatarios", "El testador lega a su amigo un departamento que pertenece a una sociedad de terceros. El testamento no muestra que supiera que la cosa era ajena, ni el legatario es descendiente, ascendiente o conyuge. El amigo ya eligio cortinas.", ["Legado de especie ajena", "No consta conocimiento del testador", "Legatario tercero sin regla protectora especial"], "Distinguir el legado nulo de cosa ajena de la obligacion excepcional de adquirirla.", [
    ...
    choice("Obligar siempre a los herederos a comprar el departamento.", false, "1106/1107", "Legado", "Incorrecto. Esa obligacion necesita que el testador ordene adquirir la especie o que opere una excepcion legal."),
    choice("Tratarlo como legado de genero y entregar cualquier departamento mediano.", false, "1115", "Legado de genero", "Incorrecto. Se lego una especie determinada; no se convierte en genero por frustracion inmobiliaria."),
  ]),
  caseFile("reloj-vendido", "El legado que no revivio", "Revocacion tacita de legado", 5, "herederos-legatarios", "El testador lega su reloj mecanico a Iris. Dos meses despues lo vende; la venta se anula y el reloj vuelve a su escritorio antes de morir. Iris sostiene que el legado resucito porque el reloj tambien volvio.", ["Legado de especie", "Enajenacion entre vivos posterior", "La especie vuelve al patrimonio del testador"], "Aplicar la revocacion tacita del legado por enajenacion de la especie, aunque la cosa vuelva.", [
    choice("Mantener el legado porque la cosa estaba otra vez en poder del testador al morir.", false, "1135", "Legado", "Incorrecto. La vuelta fisica de la cosa no revive el legado revocado por enajenacion."),
    choice("Entender revocado el legado por la enajenacion entre vivos, aunque esta haya sido nula.", true, "1135", "Revocacion tacita", "Correcto. La enajenacion de la especie legada envuelve revocacion y no revive por retorno posterior."),
    choice("Convertir el legado en credito por el valor del reloj.", false, "1135", "Legado de especie", "Incorrecto. La regla extingue o revoca el legado; no lo recicla como indemnizacion sucesoria."),
  ]),
  caseFile("sustraccion-inventario", "La caja antes del inventario", "Aceptacion forzada por sustraccion", 5, "posesion-herencia", "Una heredera retira efectos de la sucesion antes del inventario y luego intenta repudiar porque aparecieron deudas. Dice que solo 'resguardo' la caja. El sistema encuentra la caja vendida en una feria de reliquias.", ["Sustraccion de efectos hereditarios", "Repudiacion posterior", "Objetos no incluidos en inventario"], "Aplicar la sancion del heredero que sustrae efectos de la sucesion.", [
    choice("Permitir la repudiacion si devuelve el valor de la caja.", false, "1231", "Repudiacion", "Incorrecto. La sustraccion hace perder la facultad de repudiar y excluye participacion en los objetos sustraidos."),
    choice("Mantenerla como heredera pese a repudiar, pero sin parte en los objetos sustraidos.", true, "1231", "Sustraccion", "Correcto. El Codigo castiga la maniobra: no puede usar el repudio como salida de emergencia."),
    choice("Declarar beneficio de inventario automatico por existir deudas.", false, "1247", "Beneficio", "Incorrecto. El beneficio de inventario no limpia la sustraccion previa."),
  ]),
  caseFile("posesion-efectiva-mito", "El decreto que llego tarde", "Posesion legal de la herencia", 5, "posesion-herencia", "La heredera toma medidas conservativas al dia siguiente de la muerte. Un tercero objeta que aun no tiene posesion efectiva. Ella responde que la delacion no espera timbres administrativos.", ["Muerte y delacion ya ocurridas", "No hay decreto de posesion efectiva aun", "Medidas conservativas sobre la herencia"], "Distinguir posesion legal de la herencia y tramite de posesion efectiva.", [
    choice("Negar toda posesion hereditaria hasta el decreto de posesion efectiva.", false, "722", "Posesion", "Incorrecto. La posesion de la herencia se adquiere desde que es deferida, incluso si el heredero lo ignora."),
    choice("Reconocer posesion legal desde la delacion, sin confundirla con posesion efectiva.", true, "722/1222", "Posesion hereditaria", "Correcto. El decreto ordena y acredita, pero no crea desde cero la posicion hereditaria."),
    choice("Exigir particion previa para cualquier acto conservativo.", false, "1317", "Particion", "Incorrecto. La particion no es requisito para proteger la masa hereditaria."),
  ]),
  caseFile("testamento-bajo-fuerza", "La firma con amenaza", "Fuerza en testamento", 5, "clases-sucesion", "La testadora firma un testamento luego de que un heredero la amenaza con internarla y aislarla. El documento tiene solemnidades impecables; el consentimiento, no. La tinta se ve perfecta y aun asi tiembla.", ["Amenaza determinante", "Testamento formalmente prolijo", "Asignatario beneficiado por la presion"], "Distinguir solemnidad externa de libertad testamentaria y declarar la nulidad por fuerza.", [
    ...
    choice("Usar solo accion de reforma porque hay asignatarios forzosos.", false, "1216", "Reforma", "Incorrecto. Si el vicio es fuerza, el problema no es solo legitima lesionada; es validez del testamento completo."),
  ]),
  caseFile("acervo-con-sociedad", "La planilla con bienes mezclados", "Acervos y bajas generales", 5, "acervos-calculo", "El inventario bruto mezcla bienes propios del causante, bienes sociales no liquidados, deudas hereditarias, gastos de ultima enfermedad y una donacion imputable a una hija. Un heredero quiere calcular legitimas sobre el total bruto porque 'asi duele menos'.", ["Bienes confundidos con sociedad conyugal", "Bajas generales pendientes", "Donacion imputable a legitimaria"], "Ordenar el calculo: separar bienes ajenos o sociales, deducir bajas generales y luego agregar donaciones acumulables.", [
    choice("Calcular legitimas directamente sobre el acervo bruto mezclado.", false, "959/1185", "Acervos", "Incorrecto. El bruto no es base final; primero se depura la masa."),
    choice("Separar lo ajeno, deducir bajas generales y despues formar acervos imaginarios si procede.", true, "959/1185", "Acervo liquido", "Correcto. La sucesion se calcula con bisturi: separar, bajar, agregar y recien distribuir."),
    choice("Ignorar la donacion porque las bajas generales tienen prioridad.", false, "1185", "Primer acervo", "Incorrecto. Las bajas se deducen antes, pero la donacion imputable puede volver al calculo imaginario."),
  ]),
];
